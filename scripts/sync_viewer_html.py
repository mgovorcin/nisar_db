...
def main(argv: list[str] | None = None) -> None:
    ...
    parser.add_argument(
        "--gps-json",
        type=Path,
        default=gen.DEFAULT_GPS_SITES,
        help="GeoJSON of UNR GPS sites to embed.",
    )
    parser.add_argument(
    ...
    gps_sites = gen.load_gps_sites(None if args.no_gps else args.gps_json)
